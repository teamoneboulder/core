<?php
	class BADGE{
		...
		public static function load($r){
			$c=db2::findOne(phi::$conf['dbname'],'badge',array('id'=>self::$id));
			$schema=ONE_CORE::getSchema('badge');
			#die(json_encode($schema));
			if(isset($schema['graph'])) $c=db2::graphOne(phi::$conf['dbname'],$c,$schema['graph']);
