<?php
	class ticket_checkout{
		...
		public static $paltformFeeCalculation=100;//'.70+.03*[total]';
		...
		public static function reserve($r){
			...
			$resp['paltformFeeCalculation']=self::$paltformFeeCalculation;
			return $resp;
		}
		...
		public static function getPlatformFees($total,$absorb=false){
			if($total>200){
				try{
					$ca=floor(eval('return '.phi::parseString(self::$paltformFeeCalculation,[
						'total'=>$total
					]).';'));
					return $ca;
				}catch(Exception $e){
