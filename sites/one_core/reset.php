<?php
  ...
  $r=API::parseRequest();
  $data=db2::findOne($conf['dbname'],'reset',array('id'=>$r['path'][2]));
?>
...
<!--[if (gt IE 9)|!(IE)]><!--> <html xmlns="http://www.w3.org/1999/xhtml"> <!--<![endif]-->
  <head> 
    ...
    <script>
      ...
      ?>;
      ;window.resetdata=JSON.parse('<?php echo json_encode($data);?>');
    </script>
</head> 
<body onload="onLoad()" style="background:rgb(29, 58, 136)">
