...
@keyframes load {
  ...
  100% {
    ...
    <div id="splash" class="sfit" style="z-index: 2">
        <div id="splashlogo" class="coverimg sfit" style="background-image:url(dist/default_splash.jpg)"></div>
    </div>
