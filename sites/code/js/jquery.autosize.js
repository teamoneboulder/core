	...
	$.AutosizedTextarea.prototype = {
		...
		observe: function() {
			...
			this.$textarea
				...
				.on('refresh.autosize', this.adjust.bind(this))
			;
		},
		adjust: function() {
			...
			var scroller=(this.options.getScroller)?this.options.getScroller():false
			if(!scroller) scroller=$window;
			var currentWindowScroll = scroller.scrollTop();
			...
			scroller.scrollTop(currentWindowScroll);
