(function (global, factory) {
    ...
    var Impetus = function Impetus(_ref) {
        ...
        function callEndCallback() {
            if(endCallback) endCallback.call(sourceEl, targetX, targetY);
        }
        /**
         * Executes the start function
         */
        function callStartCallback() {
            if(startCallback) startCallback.call(sourceEl, targetX, targetY);
        }
