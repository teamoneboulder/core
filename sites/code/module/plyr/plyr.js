typeof navigator === "object" && (function (global, factory) {
  ...
  var controls = {
    ...
    inject: function inject() {
      ...
      if (is.function(this.config.controls)) {
        ...
        this.config.controls = this.config.controls.call(this);
  ...
  var defaults = {
    ...
    classNames: {
      ...
      responsiveControls: 'plyr__control__responsive',
  ...
  function () {
    ...
    _createClass(Fullscreen, [{
      ...
      value: function enter() {
        ...
        if(this.player.config.fullscreen&&this.player.config.fullscreen.callback){
          this.player.config.fullscreen.callback(this);
        }else if (browser.isIos && this.player.config.fullscreen.iosNative) {
  ...
  var ui = {
    ...
    build: function build() {
      ...
      if(this.config.responsiveControls){
        toggleClass(this.elements.container, this.config.classNames.responsiveControls,1); // Ready for API calls
      }
  ...
  function () {
    ...
    _createClass(Listeners, [{
      ...
      value: function media() {
        ...
        // on.call(player, player.media, 'play pause', function (event) {
        //     //console.log('play/pause');
        //     if(player.config.rebuildUI){
        //       //unbindListeners.call(player);
        //       controls.inject.call(pla);
...
! function(e, t) {
    ...
    function n() {
        u(t.body, f.events.start, l), u(t.body, f.events.move, l), u(t.body, f.events.end, l)
    }
    ...
    function a(n, o, a) {
        if (n && o) {
            var r;
            "function" == typeof e.CustomEvent ? r = e.CustomEvent : (r = function(e, n) {
                n = n || {
                    bubbles: !1,
                    cancelable: !1,
                    detail: void 0
    ...
    function r() {
        return [f.selectors.range, ":not(", f.selectors.disabled, ")"].join("")
    }

    function i(e) {
        return !(e instanceof HTMLElement) || (e.matches(f.selectors.disabled) || e.disabled)
    }
    ...
    function s(e) {
        var t, n = e.target,
            ...
            i = parseFloat(n.getAttribute("step")) || 1,
            u = r - a,
            d = n.getBoundingClientRect(),
            s = 100 / d.width * (f.thumbWidth / 2) / 100;
        return t = 100 / d.width * (o.clientX - d.left), t < 0 ? t = 0 : t > 100 && (t = 100), t < 50 ? t -= (100 - 2 * t) * s : t > 50 && (t += 2 * (t - 50) * s), a + c(u * (t / 100), i)
    }

    function l(e) {
        f.enabled && "range" === e.target.type && !i(e.target) && (e.preventDefault(), e.target.value = s(e), a(e.target, e.type === f.events.end ? "change" : "input"))
    }
    var f = {
        enabled: !0,
        addCSS: !0,
    ...
    return function() {
        if ("ontouchstart" in t.documentElement) {
            if (f.addCSS&&false) {
                var e = t.styleSheets;
                (e.length ? e[0] : o()).insertRule(r() + " { user-select: none; -webkit-user-select: none; touch-action: manipulation; }", 0)
            }
            n()
        }
    }(), {
